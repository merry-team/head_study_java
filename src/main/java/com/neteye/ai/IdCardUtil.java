...
public class IdCardUtil {
	...
	public static void main(String[] args) throws Exception { 
		String idcard18 = "232700199206060847";// String
		idcard18 = "430225197902160020";// String   //430225197902160020  43022419702160024 430224197902160040 430224197902160067
		String idcard15 = "130321860311519";
		System.out.println(isValidatedAllIdcard(idcard18)); // 18位身份证
		System.out.println(convertIdcarBy15bit(idcard15));
