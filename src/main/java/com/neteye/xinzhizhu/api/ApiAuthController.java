...
import com.neteye.xinzhizhu.entity.FullUserInfo;
import com.neteye.xinzhizhu.entity.UserInfo;
...
//    @IgnoreAuth
    ...
    public Object loginByWeixin() {
        ...
        logger.debug("》》》组合token为：" + requestUrl);
