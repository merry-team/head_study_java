...
//	@Value("${wxinfo.certPath}")
//	private static String CERTPATH ;
//	@Value("${wxinfo.mch_id}")
//	private static String MCH_ID ;
	
	private static String CERTPATH ="apiclient_cert.p12";
	private static String MCH_ID="1495127012" ;
...
//	static{
//		Yaml yaml = new Yaml();
//		URL url = HttpPropertiesUtils.class.getClassLoader().getResource("application.yml");
//		if (url != null) {
//			
//			try {
//				Map map =(Map)yaml.load(new FileInputStream(url.getFile()));
//				Map spring =(Map)map.get("spring");
//				Map wxinfo =(Map)spring.get("wxinfo");
//				String CERTPATH =(String) wxinfo.get("certPath");
//				String MCH_ID =(String) wxinfo.get("mch_id");
//				Resource resource = new ClassPathResource(CERTPATH);
//				KeyStore keystore = KeyStore.getInstance("PKCS12");
//				//char[] keyPassword = ConfigUtil.getProperty("wx.mchid").toCharArray(); //证书密码
//				char[] keyPassword = MCH_ID.toCharArray(); //证书密码
